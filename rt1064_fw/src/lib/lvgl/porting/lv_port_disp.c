...
void lv_port_disp_init(void)
{
    ...
    lv_disp_buf_init(&disp_buf, p_buf_1, p_buf_2, LV_HOR_RES_MAX * LV_VER_RES_MAX);   /*Initialize the display buffer*/
#endif
    ...
    disp_drv.hor_res = lcdGetWidth();
    disp_drv.ver_res = lcdGetHeight();
