...
gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
{
  ...
  {GPIO1, 19, _DEF_OUTPUT,  _DEF_HIGH, _DEF_LOW},   // 1. SDCARD_PWREN

  {GPIO1,  2, _DEF_OUTPUT,  _DEF_HIGH, _DEF_LOW},   // 2. LCD_RST
  {GPIO2, 31, _DEF_OUTPUT,  _DEF_HIGH, _DEF_LOW},   // 3. LCD_BKL
};
